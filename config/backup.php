...
return [
    ...
    'backup' => [
        ...
        'destination' => [
             ...
             *
             * Production tövsiyəsi: off-site destination (S3, Backblaze B2) əlavə
             * et — `BACKUP_DISK=s3` .env-də və `filesystems.php`-də ayrı S3 disk.
             * Hazırda lokal disk istifadə olunur (`storage/app/Paylo`); production-da
             * server itməsi senaryosunda bu yox olur.
             */
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'admin@paylo.az'),
